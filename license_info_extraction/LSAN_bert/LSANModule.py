...
class StructuredSelfAttention(BasicModule):
    ...
    def forward(self, input_ids, token_type_ids, attention_mask, label_input_ids, label_attention_masks):
        ...
        _, label_pooled_output = self.bert(input_ids=label_input_ids, attention_mask=label_attention_masks)

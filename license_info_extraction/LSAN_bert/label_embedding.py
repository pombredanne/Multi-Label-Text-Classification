...
label_definition_list = [
    ...
    ['licence and copyright notice', 'include the license file and or the copyright notice when distributing the original or copy of the software'],
    ['same license', 'the modified or altered or derived versions of the software must be distributed under the license and or the copyright notice of the original software'],
